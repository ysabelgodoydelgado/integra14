...
class PurchaseReport(models.Model):
    ...
    def _select(self):
        return super()._select() + (", po.foreign_amount_untaxed AS foreign_amount_untaxed" +
                                    ", po.foreign_amount_tax AS foreign_amount_tax" +
                                    ", po.foreign_amount_total AS foreign_amount_total")
        ...
        if foreign_currency_id and foreign_currency_id == '2':
            ...
            if view_type == "dashboard":
                ...
                if foreign_amount_total_all:
                    foreign_amount_total_all[0].set("string", "Total Comprado $")
                    res["arch"] = etree.tostring(doc, encoding="unicode")
